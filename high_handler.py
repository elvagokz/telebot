...
def handle_high(bot: Any, message: Message) -> None:
    """
    ...
    bot.register_next_step_handler(message, lambda m: handle_high_response(bot, m))

def handle_high_response(bot: Any, message: Message) -> None:
    """
    ...
    try:
        ...
        actors_info = get_actors(num_actors_to_display, reverse=False)
